...
var TMI_6 = TMI(topic: "6", emoji: "💚", title: "6", description: "녹차아이스크림 색소는 누에똥으로 만든다", writer: haneul)
var TMI_7 = TMI(topic: "7", emoji: "🥃", title: "7", description: "트럼프는 가족력으로 술을 아예 안 마신다", writer: haneul)
var TMI_8 = TMI(topic: "8", emoji: "🪳", title: "8", description: "바퀴벌레는 사람과 닿으면 하루종일 자기 몸을 닦는다", writer: haneul)
var TMI_9 = TMI(topic: "9", emoji: "🪳", title: "9", description: "라쿠카라차~ 는 스페인어로 바퀴벌레다", writer: haneul)
var TMI_10 = TMI(topic: "10", emoji: "🦜", title: "10", description: "남의 앵무새에게 욕을 가르치면 재물손괴죄이다", writer: haneul)
